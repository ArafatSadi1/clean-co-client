...
const Navbar = ({ children }) => {
  ...
  return (
    <div class="drawer  drawer-end" data-theme={!dark ? "light" : "dark"}>
      ...
      <div class="drawer-side">
        ...
        <ul class="menu p-4 overflow-y-auto w-80 bg-base-100">
          ...
          <div tabindex="0" class="collapse border rounded-lg">
            <div class="collapse-title btn-md btn btn-primary btn-outline">
              Book Now
            </div>
            <div class="collapse-content">
              <li>
                <NavLink to="/quickBook" className="rounded-lg">
                  Quick Book
                </NavLink>
              </li>
              <li>
                <NavLink to="/PreBook" className="rounded-lg">
                  Pre Book
                </NavLink>
              </li>
            </div>
